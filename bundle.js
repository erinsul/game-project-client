...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamePlayEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hideSignUpForm = function hideSignUpForm() {
	  $('#sign-up-form').hide();
	};
	var hideSignInForm = function hideSignInForm() {
	  $('#sign-in-form').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var gameBoard = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var winVerify = __webpack_require__(13);
	var cells = [" ", " ", " ", " ", " ", " ", " ", " ", " "];
	var setGameObjectIndex = function setGameObjectIndex(object, id) {
	  switch (id) {
	    case "zero":
	...
	var setGameObject = function setGameObject(marker, id) {
	  var gameObject = {
	    "game": {
	      "cell": {},
	      "over": false
...
/***/ function(module, exports) {
	...
	var win = function win(array, marker) {
	  var winState = false;
	  if (array[0] === marker && array[1] === marker && array[2] === marker || array[3] === marker && array[4] === marker && array[5] === marker || array[6] === marker && array[7] === marker && array[8] === marker || array[0] === marker && array[3] === marker && array[6] === marker || array[1] === marker && array[4] === marker && array[7] === marker || array[2] === marker && array[5] === marker && array[8] === marker || array[0] === marker && array[4] === marker && array[8] === marker || array[2] === marker && array[4] === marker && array[6] === marker) {
	    winState = true;
	  }
	  return winState;
	};

	var tie = function tie(array) {
	  if (!array.includes(" ")) {
	    return true;
	  }
	};
